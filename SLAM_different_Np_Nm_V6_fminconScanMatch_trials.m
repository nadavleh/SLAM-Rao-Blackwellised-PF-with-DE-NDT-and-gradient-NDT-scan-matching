...
threshold=0.6; % the threshold to turn the initial prob map to actual obsticales
...
lb = [trans_vec(1)-0.5, trans_vec(2)-0.5, trans_vec(3)-0.2];
ub = [trans_vec(1)+0.5, trans_vec(2)+0.5, trans_vec(3)+0.2]; 
...
% and starting the second timestep it diverges                              %
    ...
    hold on                                                                 %
    scatter(next_scan_calc(1,:),next_scan_calc(2,:),0.5,'k')                %
    hold off                                                                %
    axis square                                                             %
    zoom(1.15)                                                               %
    title('current scan (b), next scan (r), next to current ref-frame (k)') %
    drawnow
% % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % % %

%% vesrion V4:
% here i finally succeeded to perform SLAM. once i advance each set of
% Np prtcls in each of the Nm maps, i weigh them and resample the prtcle.
% then i calculate their mean state and build the next time-steps map,
% according to the mean location and next timesteps scans.
